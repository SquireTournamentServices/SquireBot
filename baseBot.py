...
BASE_LINK = "https://github.com/MonarchDevelopment/SquireBot/blob/main/docs/"
LINK_TO_PLAYER_CMD_DOC = f"{BASE_LINK}/UserCommands.md"
LINK_TO_JUDGE_CMD_DOC = f"{BASE_LINK}/JudgeCommands.md"
LINK_TO_ADMIN_CMD_DOC = f"{BASE_LINK}/AdminCommands.md"
LINK_TO_CRASH_COURSE_DOC = f"{BASE_LINK}/CrashCourse.md"
...
async def isAdmin(ctx, send: bool = True) -> bool:
    ...
    for role in ctx.author.roles:
        ...
        digest |= str(role).lower() == "tournament judge"
