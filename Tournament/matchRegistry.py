...
class MatchRegistry:
    ...
    def loadMatches(self, location: str) -> None:
        ...
        matchFiles = [
            ...
            if os.path.isfile(f"{location}/{f}")
        ]
        for matchFile in matchFiles:
            ...
            newMatch.players = [
                self.playerReg.getPlayer(plyr) for plyr in newMatch.players
            ]
            newMatch.activePlayers = [
                self.playerReg.getPlayer(plyr) for plyr in newMatch.activePlayers
            ]
            newMatch.droppedPlayers = [
                self.playerReg.getPlayer(plyr) for plyr in newMatch.droppedPlayers
            ]
            newMatch.confirmedPlayers = [
                self.playerReg.getPlayer(plyr) for plyr in newMatch.confirmedPlayers
            ]
